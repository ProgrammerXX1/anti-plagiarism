...
async def search(
    ...
    include_matches: bool = Query(True, description="Include shingle offsets arrays per hit"),
    max_matches_per_doc: int | None = Query(None, ge=0, le=5000, description="Trim matches arrays per hit (python-side)"),
